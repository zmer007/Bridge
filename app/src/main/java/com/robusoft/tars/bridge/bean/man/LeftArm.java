...
public class LeftArm extends Limbs {

	private Path path;

	public LeftArm(int armStartX, int armStartY, int armLength) {
	...
	private float[] getControlCoor() {
		...
		float cx = (float) (ax - AC * Math.sin(Math.toRadians(theta)));
		float cy = ay;
